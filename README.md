...
**Скачать видео для тестирования:** [ССЫЛКА_НА_GOOGLE_DISK](https://drive.google.com/drive/folders/1YHMqmRlpq6VMuYQrPMJUbs1xkr9IhG30?usp=drive_link)

**Скачать предобученную модель :** [ССЫЛКА_НА_GOOGLE_DISK](https://drive.google.com/file/d/1SPFGbHfr-UTaKILOSwnpsC7D6ehSPdhp/view?usp=drive_link)
...
3. Подготовьте данные:
   - Поместите видеофайлы в папку `test_video`
   - Скачать предобученную модель и убедиться, что файл `pose_estimation_model.pth` находится в корневой директории проекта
